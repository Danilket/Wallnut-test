...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.menu-header__icon').click(burgerClick);
  jquery__WEBPACK_IMPORTED_MODULE_0__('.menu__title').click(burgerClick);

  function burgerClick() {
    jquery__WEBPACK_IMPORTED_MODULE_0__(this).toggleClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0__('.menu-header__menu').toggleClass('active');

    if (jquery__WEBPACK_IMPORTED_MODULE_0__(this).hasClass('active')) {
      jquery__WEBPACK_IMPORTED_MODULE_0__('body').data('scroll', jquery__WEBPACK_IMPORTED_MODULE_0__(window).scrollTop());
    }

    jquery__WEBPACK_IMPORTED_MODULE_0__('body').toggleClass('lock');

    if (!jquery__WEBPACK_IMPORTED_MODULE_0__(this).hasClass('active')) {
      jquery__WEBPACK_IMPORTED_MODULE_0__('body,html').scrollTop(parseInt(jquery__WEBPACK_IMPORTED_MODULE_0__('body').data('scroll')));
    }
  }

  var tel = document.querySelector(".forms__number");
  var im = new inputmask__WEBPACK_IMPORTED_MODULE_2___default.a();
  im.mask(tel);
  jquery__WEBPACK_IMPORTED_MODULE_0__('.modal-window__call').click(function () {
    var tel = document.querySelector(".forms__number");
    var lastLetter = tel.value.split('');
    console.log(lastLetter[17]);

    if (lastLetter[17] == '_' || lastLetter[17] == undefined) {
      jquery__WEBPACK_IMPORTED_MODULE_0__(".text-tel").addClass('error');
    }

    if (jquery__WEBPACK_IMPORTED_MODULE_0__('.forms__name').val() == '') {
      jquery__WEBPACK_IMPORTED_MODULE_0__(".text-name").addClass('error');
    }

    if (lastLetter[17] !== '_' && lastLetter[17] !== undefined && jquery__WEBPACK_IMPORTED_MODULE_0__('.forms__name').val() !== '') {
      jquery__WEBPACK_IMPORTED_MODULE_0__["fancybox"].close();
      jquery__WEBPACK_IMPORTED_MODULE_0__["fancybox"].open(jquery__WEBPACK_IMPORTED_MODULE_0__('.modal-window_thx'));
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__('.owl-carousel').owlCarousel({
    margin: 10,
    dots: true,
    responsive: {
      0: {
